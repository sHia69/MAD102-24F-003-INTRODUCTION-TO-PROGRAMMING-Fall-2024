# Author: Hia Al Saleh 
# Date: September 20th of the year 2024
# File: Assignment_2
# Purpose: This program sums the test, the quiz and the assignment for the MAD-102 course then calculates for the weighted total as well it calculates the grade for MAD102.
...
# Overall average
overall_average = (test_average * 0.60) + (quiz_average * 0.10) + (assignment_average * 0.30)
...
print(f"Overall Average: {int(overall_average)}%") # Overall Averege 

# Grade and grade description

if overall_average >= 80:
    grade = "A"
    gradeDes = "First Class"
elif overall_average >= 70:
    grade = "B"
    gradeDes = "Second Class Upper Division"
elif overall_average >= 60:
    grade = "C"
    gradeDes = "Second Class Lower Division"
...
print(f"Grade Description: {gradeDes}") # Grade Description